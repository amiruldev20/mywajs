...
return document.evaluate(path, document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
    ...
    async searchMessages(query, options = {}) {
        const messages = await this.playPage.evaluate(async ({
            query,
            page,
            count,
            remote
    ...
    async setEphemeral(chatId, ephemeralDuration) {
        ...
        await this.playPage.evaluate(async (chatId, ephemeralDuration) => {
    ...
    async createGroup(name, participants) {
        ...
        const createRes = await this.playPage.evaluate(async (name, participantIds) => {
    ...
    async getStories(chatId = this.info.wid._serialized) {
        const message = await this.playPage.evaluate((chatId) => {
            if (chatId === 'all') {
